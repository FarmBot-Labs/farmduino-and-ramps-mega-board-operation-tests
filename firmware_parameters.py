...
PARAMETERS = {
    ...
    'Invert endpoints': [
        {'axis': 'x', 'num': 21, 'value': 0},
        {'axis': 'y', 'num': 22, 'value': 0},
        {'axis': 'z', 'num': 23, 'value': 0}],
    'Enable endstops': [
    ...
    'Acceleration (steps)': [
        {'axis': 'x', 'num': 41, 'value': 300},
        {'axis': 'y', 'num': 42, 'value': 300},
        {'axis': 'z', 'num': 43, 'value': 300}],
    'Stop at home': [
    ...
    'Steps per mm': [
        {'axis': 'x', 'num': 55, 'value': 1},
        {'axis': 'y', 'num': 56, 'value': 1},
        {'axis': 'z', 'num': 57, 'value': 1}],
    'Min speed (steps/s)': [
        {'axis': 'x', 'num': 61, 'value': 100},
        {'axis': 'y', 'num': 62, 'value': 100},
        {'axis': 'z', 'num': 63, 'value': 100}],
    'Home speed (steps/s)': [
        {'axis': 'x', 'num': 65, 'value': 100},
        {'axis': 'y', 'num': 66, 'value': 100},
        {'axis': 'z', 'num': 67, 'value': 100}],
    'Max speed (steps/s)': [
    ...
    'Encoder scaling': [
        {'axis': 'x', 'num': 115, 'value': 5556},
        {'axis': 'y', 'num': 116, 'value': 5556},
        {'axis': 'z', 'num': 117, 'value': 5556}],
    'Decay (steps)': [
...
PARAMETER_SEEDS = [
    ...
    {'name': 'Invert endpoints', 'start_number': 21, 'value': 0},
    {'name': 'Enable endstops', 'start_number': 25, 'value': 0},
    {'name': 'Invert motor', 'start_number': 31, 'value': 0},
    {'name': 'Acceleration (steps)', 'start_number': 41, 'value': 300},
    {'name': 'Stop at home', 'start_number': 45, 'value': 0},
    {'name': 'Negatives only', 'start_number': 51, 'value': 0},
    {'name': 'Steps per mm', 'start_number': 55, 'value': 1},
    {'name': 'Min speed (steps/s)', 'start_number': 61, 'value': 100},
    {'name': 'Home speed (steps/s)', 'start_number': 65, 'value': 100},
    ...
    {'name': 'Encoder scaling', 'start_number': 115, 'value': 5556},
